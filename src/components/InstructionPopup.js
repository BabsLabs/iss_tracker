  ...
  render() {
    return (
      <div id="instructions">
        ...
        <p>- Toggle all NASA registered ground based observatories by clicking the Observatory Toggle button<img src={observatoryLogo} alt="(ISS LOGO)" className="observatory-toggle-instructions" /></p>
